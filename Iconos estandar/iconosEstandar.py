# -*- coding: utf-8 -*-
# ----------------------------------------------------------------------------
# Nombre:       iconosEstandar.py
# Autor:        Miguel Andres Garcia Niño
# Creado:       03 de Junio 2018
# Modificado:   03 de Junio 2018
...
"""
El módulo *iconosEstandar* permite utilizar los iconos estándar de PyQt5.
"""
...
class ventanaPrincipal(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Lista de iconos estándar en PyQt5")
        self.resize(350, 350)
